import os; import subprocess;import tkinter as tk; import tkinter.messagebox
...
def getting_input():
    ...
    subprocess.run(["yt-dlp", "-P", DOWNLOADS_FOLDER, url[0]])
    file_name = [i for i in os.listdir(DOWNLOADS_FOLDER) if i.endswith(".webm")][0]
...
# download button
button = tk.Button(root, text='download', command=getting_input)
button.pack()
